  ...
  if (done) {
    return (
      <div className="max-w-sm mx-auto px-5 py-20 text-center">
        <h1 className="font-black text-xl mb-2 text-ink">Registration submitted!</h1>
        <p className="text-sm text-muted mb-4">
          Your registration code: <span className="font-bold text-ink">{done}</span>
        </p>
        <p className="text-sm text-muted mb-6">
          Pay the entry fee via UPI and upload your payment screenshot from your dashboard to confirm your spot.
        </p>
